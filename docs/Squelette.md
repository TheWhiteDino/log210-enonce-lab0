...
3. Le Système affiche le nom du joueur et le résultat de la partie, ainsi que le nombre de parties et le nombre de fois que le Joueur a gagné. Pour un lancer, si le total est inférieur ou égal à 10, le Joueur a gagné. Dans tous les autres cas, il a perdu.
